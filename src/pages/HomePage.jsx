        ...
        <section className="empowerment-section">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p>Get AI-powered insights into your own communication patterns, helping you build self-awareness.</p>
            </div>
            <div className="benefit-card">
               <div className="benefit-icon">
              ...
              <p>Move past misunderstanding by learning to speak your audience's "language" to reduce conflict.</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">
              ...
              <p>Tackle difficult conversations with a clear strategy, empowering you to express yourself effectively.</p>
            </div>
          </div>
        </section>
      </aside>
